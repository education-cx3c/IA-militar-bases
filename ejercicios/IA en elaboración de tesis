# 🧩 Ejercicio 1 — Resuelto y Trazable
...
### Prompt 02 — Principios Éticos y Doctrinales
- **Tipo**: Anal. + Transf.
- **Prompt**:  
...
## 2) Producto Integrado (para presentar al Consejo Académico)
...
**8. Evaluación y Control de Calidad**  
